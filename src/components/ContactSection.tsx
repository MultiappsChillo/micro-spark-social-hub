      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-gray-600">
            Bereit für Ihre nächste Influencer-Marketing-Kampagne? Kontaktieren Sie uns, um loszulegen.
          </p>
        </div>
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <Input placeholder="ihre@email.de" type="email" />
                </div>
              </div>
              ...
              <div>
                ...
                <Select>
                  ...
                  <SelectContent>
                    <SelectItem value="brand">Markenvertreter</SelectItem>
              ...
              <div>
                ...
                <Textarea placeholder="Erzählen Sie uns von Ihrem Projekt oder Ihrer Anfrage" rows={5} />
              </div>
